...
def run_ffmpeg_patcher():
    ...
    if ffmpeg_in_path:
        ...
        print("Press any key to back to settings...")
...
def wizard_mode():
    ...
    while True:
        ...
        if key == '0':
            ...
            print("Here is your answer, want start download?")
            ...
            try:
                ...
                for item in os.listdir(current_cfg['download_path']):
                    ...
                    if item.lower().endswith(('.webp', '.png', '.jpg')):
                        ...
                        if os.path.exists(os.path.join(current_cfg['download_path'], base_name + ".mp4")) or os.path.exists(os.path.join(current_cfg['download_path'], base_name + ".mp3")):
